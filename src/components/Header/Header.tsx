...
type DarkModeIconProps = Readonly<{
	onClick: () => void;
}>;

function DarkModeIcon({ onClick }: DarkModeIconProps) {
	return (
...
type LightModeIconProps = Readonly<{
	onClick: () => void;
}>;

function LightModeIcon({ onClick }: LightModeIconProps) {
	return (
		<button type="button" onClick={onClick}>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style={{ width: "1.5rem", height: "1.5rem" }}>
